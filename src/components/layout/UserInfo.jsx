   ...
   return (
      <React.Fragment>
            ...
            <div className="login-content">
               <form action="#" method="post">
                  ...
                  <div className="d-flex-column">
                     <a href='#!' type="submit" className="btn-submit">Sign in</a>
                     <a href='#!' className="btn-outline">Create An Account</a>
                  </div>
         ...
         <div className={sidebarCartClass}>
                     ...
                     <Box sx={{ margin: '0.8rem 0', width: '100%' }} key={item.id}>
                        <Stack direction={'row'} spacing={'2rem'} className='product-info' >
                           ...
                           <Stack direction="column" spacing="1.5rem" alignItems={'flex-start'}>
                              ...
                              <p>SubTotal: <span>${productSubtotal}</span></p>
                              <Stack direction={'row'} spacing={'2rem'} alignItems={'center'} className="quantity" sx={{ fontSize: '1.3rem' }}>
                                 <span>Quantity: </span>
            ...
            <Link to="/cart" className="btn-outline" onClick={closeCartHandler}>Continue Shopping</Link>
         </div>
