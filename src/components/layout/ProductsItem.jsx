...
import { Review, ProductPrice } from "../layout/helper";
   ...
   return (
      <Paper className='product-item' elevation={0} >
         ...
         <Box className="card-content" sx={{ padding: '3rem 0' }}>
            ...
            <button className='btn btn-cart' onClick={props.addToCartHandler}>Add to Cart</button>
         </Box>

      </Paper >
   );
};
// onClick={props.detailPageHandler()}
